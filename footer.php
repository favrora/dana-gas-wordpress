      ...
      <div class="row">
        <div class="col-12 col-md-6 col-lg-3">
          <div class="footer-menu__list">
            ...
            <div class="footer-menu__links">
              <a href="<?php echo get_site_url() ?>/about-us/overview/">Our story</a>
        ...
        <div class="col-12 col-md-6 col-lg-2">
          <div class="footer-menu__list">
            ...
            <div class="footer-menu__links">
              <a href="<?php echo get_site_url() ?>/about-us/governance/committees/">Board committees</a>
       ...
       <div class="row">
         <div class="col-12 col-md-6 col-lg-3">
           <div class="footer-menu__list">
             ...
             <div class="footer-menu__links">
               <a href="<?php echo get_site_url() ?>/about-us/overview/">قصتنا</a>
         ...
         <div class="col-12 col-md-6 col-lg-2">
           <div class="footer-menu__list">
             ...
             <div class="footer-menu__links">
               <a href="<?php echo get_site_url() ?>/about-us/governance/committees/">لجان مجلس الإدارة</a>
          ...
          <?php if (ICL_LANGUAGE_CODE == 'en') : ?>
            ...
            <div class="col-12 col-md-6">
              <div class="copyright-text">
                Copyright © <?php echo date('Y') ?>. Dana Gas PJSC. All rights reserved.
              </div>
            </div>
          <?php elseif (ICL_LANGUAGE_CODE == 'ar') : ?>
            <div class="col-12 col-md-6">
            ...
            <div class="col-12 col-md-6">
              <div class="copyright-text">
                حقوق النشر © <?php echo date('Y') ?>. دانة غاز ش. كل الحقوق محفوظة.
              </div>
            </div>
          <?php endif; ?>
