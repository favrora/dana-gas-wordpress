...
<!-- About section -->
<section class="about-section" style="background-image: url('<?php echo get_template_directory_uri() . '/assets/images/careers-bg.png'; ?>')">
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-md-6">
        ...
        <img src="<?php echo get_field('working_with_us_image') ?>" class="data-img" alt="Working with us" loading="lazy">
      </div>
...
<!-- Disclaimer section -->
<section class="disclaimer-section top-bg-section pt-5" style="background-image: url('<?php echo get_template_directory_uri() . '/assets/images/bg-shape/grey-shape-end.png'; ?>)">
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-md-6">
        <img src="<?php echo get_field('disclaimer_image') ?>" class="data-img" alt="Employment scam disclaimer" loading="lazy">
      </div>
