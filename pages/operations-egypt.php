...
<!-- About section -->
<section class="about-section" style="background-image: url('<?php echo get_template_directory_uri() . '/assets/images/operations-egypt-bg.png'; ?>')">
        ...
        <div class="overview-blocks">
          ...
          <div class="overview-item">
            <div class="overview-item__img">
              <img src="<?php echo get_template_directory_uri() . '/assets/images/icons/gas-production.png'; ?>" alt="Gas production icon" loading="lazy">
            </div>
          ...
          <div class="overview-item">
            <div class="overview-item__img">
              <img src="<?php echo get_template_directory_uri() . '/assets/images/icons/condensate-production.png'; ?>" alt="Condensate production icon" loading="lazy">
            </div>
            <div class="overview-item__text">
          ...
          <div class="overview-item">
            <div class="overview-item__img">
              <img src="<?php echo get_template_directory_uri() . '/assets/images/icons/lpg-production.png'; ?>" alt="LPG production icon" loading="lazy">
            </div>
            <div class="overview-item__text">
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-12 col-md-6">
        ...
        <p><?php echo get_field('nile_delta_operations') ?> <span class="showMoreText d-none"><?php echo get_field('nile_delta_operations_show_more') ?></span></p>
      ...
      <div class="col-12 col-md-6">
        ...
        <p><?php echo get_field('gas_plant') ?> <span class="showMoreText d-none"><?php echo get_field('gas_plant_show_more') ?></span></p>
