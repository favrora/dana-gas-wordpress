...
<body>
    ...
    <div class="container">
      ...
      <div class="about-scroll">
        <div class="scroll-downs" id="scrollNextBlock">
          ...
          <img src="<?php echo get_template_directory_uri() .
            "/assets/images/icons/triangle-down-white.png"; ?>" class="scroller" alt="Triangle down icon">
        </div>
      </div>
      ...
      <div class="about-info-box">
        <div class="about-info-box__img">
          <img src="<?php echo get_template_directory_uri() .
            "/assets/images/icons/hand-leaf.png"; ?>" alt="Hand leaf icon">
        </div>
  ...
  <section class="operations-section top-bg-section pb-0 mb-5" style="background-image: url('<?php echo get_template_directory_uri() .
    ...
    <div class="container">
      <div class="operations-section__pre-title"><?php echo ICL_LANGUAGE_CODE == "ar"
        ? "عمليات"
        : "Operations"; ?></div>
            ...
            <div class="card">
              <div class="card-header">
                <img src="<?php echo get_field(
                  "kri_main_card_image"
                ); ?>" alt="Kurdistan Region of Iraq" loading="lazy">
              </div>
              <div class="card-body">
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 col-lg-3">
          <div class="result-block">
            ...
            <img class="result-block__bg" src="<?php echo get_template_directory_uri() .
              "/assets/images/result-block-bg.png"; ?>" loading="lazy">
            <img class="result-block__bg-mob" src="<?php echo get_template_directory_uri() .
              "/assets/images/result-block-bg-mobile.png"; ?>" loading="lazy">
          </div>
        </div>
          ...
          <div class="row">
            ...
            <div class="col-6 col-md-4">
              <a href="https://www.danagas.com/wp-content/uploads/2022/08/20220811-Investor-Script-H1-2022.pdf" class="result-links-box" target="_blank">
                ...
                <div class="result-links-box__title"><?php echo ICL_LANGUAGE_CODE == "ar"
                  ? "نص المستثمر"
                  : "Investor script"; ?></div>
                <img src="<?php echo get_template_directory_uri() .
                  "/assets/images/right-arrow-green.png"; ?>" alt="Right arrow icon">
