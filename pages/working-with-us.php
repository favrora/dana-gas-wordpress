...
<!-- About section -->
<section class="about-section" style="background-image: url('<?php echo get_template_directory_uri() . '/assets/images/working-with-us-bg.png'; ?>')">
            ...
            <div class="col-12 col-md-5">
              <div class="company-data-box">
                <div class="company-data-box__icon">
                  <img src="<?php echo get_template_directory_uri() . '/assets/images/icons/employees-icon.png'; ?>" alt="Right arrow icon">
                </div>
              ...
              <div class="company-data-box">
                <div class="company-data-box__icon">
                  <img src="<?php echo get_template_directory_uri() . '/assets/images/icons/training-icon.png'; ?>" alt="Right arrow icon">
                </div>

                <div class="company-data-box__info">
                  <div class="company-data-box__info-title">Training days achieved a</div>
                  <div class="company-data-box__info-number"><?php echo get_field('training_days_achieved_data') ?></div>
                </div>
              </div>

              <div class="company-data-box">
                <div class="company-data-box__icon">
                  <img src="<?php echo get_template_directory_uri() . '/assets/images/icons/nationalities-icon.png'; ?>" alt="Right arrow icon">
                </div>

                <div class="company-data-box__info">
                  <div class="company-data-box__info-title">Nationalities represented</div>
                  <div class="company-data-box__info-number"><?php echo get_field('nationalities_represented_data') ?></div>
                </div>
              </div>
            </div>
        ...
        <div class="row mt-3">
                ...
                <a href="/" class="card-link">
                    <div class="card">
                        <div class="card-header">
                            <img src="<?php echo get_field('working_with_us_card_image') ?>" alt="Working with us" loading="lazy">
                        </div>
                        <div class="card-body">
            ...
            <div class="col-12 col-md-4 mb-3">
                <a href="/" class="card-link">
                    <div class="card">
                        <div class="card-header">
                            <img src="<?php echo get_field('career_opportunities_card_image') ?>" alt="Career opportunities" loading="lazy">
                        </div>
                        <div class="card-body">
            ...
            <div class="col-12 col-md-4 mb-3">
                <a href="/" class="card-link">
                    <div class="card">
                        <div class="card-header">
                            <img src="<?php echo get_field('employment_scam_disclaimer_card_image') ?>" alt="Employment scam disclaimer" loading="lazy">
                        </div>
                        <div class="card-body">
