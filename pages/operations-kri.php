...
<!-- About section -->
<section class="about-section" style="background-image: url('<?php echo get_template_directory_uri() . '/assets/images/operations-kri-bg.png'; ?>')">
...
<section class="settlement-section mt-5">
  <div class="container">
    ...
    <img src="<?php echo get_template_directory_uri() . '/assets/images/settlement-kri.png'; ?>" alt="Settlement kri" loading="lazy">
...
<section class="gas-sale-section mt-5 pb-5">
  <div class="container">
    <div class="row">
      ...
      <div class="col-12 col-md-6">
        <img src="<?php echo get_template_directory_uri() . '/assets/images/gas-sale.png'; ?>" alt="Gas sale" loading="lazy">
      </div>
